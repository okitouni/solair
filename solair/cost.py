...
def calculate_cost_air_cooler_no_fans(rho_tube, c_tm, rho_fin, c_fm, tube: Tube):
    ...
    cost_air_cooler_no_fans =  total_cost_finned_tubes * ( 1 + constants.f_header ) * (1 + constants.f_labor ) * constants.f_HX
...
def calculate_fan_lifetime_cost(pressure_drop: float, lifetime_years: float, LCOE_fanpower_cents: float):
    ...
    fan_lifetime_cost_CJHCH_100_8T_15 = n_fans_required_CJHCH_100_8T_15 * ( fan_CJHCH_100_8T_15.cost 
                                        + fan_CJHCH_100_8T_15.power /1000  # /1000 for conversion power in W to kW
                                        * LCOE_fanpower_cents /100 * 24*365 * lifetime_years )               # /100 for conversion cost in cents to $
    #2
    fan_HC_100_6H = Fan_HC_100_6H()
    airflow_Fan_HC_100_6H = fan_HC_100_6H.get_airflow_for_pressure(pressure_drop)
    n_fans_required_HC_100_6H = constants.m_air * 3000 / airflow_Fan_HC_100_6H  # *3000 for conversion kg/s to m^3/h
    fan_lifetime_cost_HC_100_6H = n_fans_required_HC_100_6H * ( fan_HC_100_6H.cost 
                                        + fan_HC_100_6H.power /1000  # /1000 for conversion power in W to kW
                                        * LCOE_fanpower_cents /100 * 24*365 * lifetime_years )               # /100 for conversion cost in cents to $
    #3
    fan_HFW_90_4_T_75 = Fan_HFW_90_4_T_75()
    airflow_Fan_HFW_90_4_T_75 = fan_HFW_90_4_T_75.get_airflow_for_pressure(pressure_drop)
    n_fans_required_HFW_90_4_T_75 = constants.m_air * 3000 / airflow_Fan_HFW_90_4_T_75  # *3000 for conversion kg/s to m^3/h
    fan_lifetime_cost_HFW_90_4_T_75 = n_fans_required_HFW_90_4_T_75 * ( fan_HFW_90_4_T_75.cost 
                                        + fan_HFW_90_4_T_75.power /1000  # /1000 for conversion power in W to kW
                                        * LCOE_fanpower_cents /100 * 24*365 * lifetime_years )               # /100 for conversion cost in cents to $
    #4
    fan_CJHCH_80_8T_05 = Fan_CJHCH_80_8T_05()
    airflow_Fan_CJHCH_80_8T_05 = fan_CJHCH_80_8T_05.get_airflow_for_pressure(pressure_drop)
    n_fans_required_CJHCH_80_8T_05 = constants.m_air * 3000 / airflow_Fan_CJHCH_80_8T_05  # *3000 for conversion kg/s to m^3/h
    fan_lifetime_cost_CJHCH_80_8T_05 = n_fans_required_CJHCH_80_8T_05 * ( fan_CJHCH_80_8T_05.cost 
                                        + fan_CJHCH_80_8T_05.power /1000  # /1000 for conversion power in W to kW
                                        * LCOE_fanpower_cents /100 * 24*365 * lifetime_years )               # /100 for conversion cost in cents to $
    #5
    fan_HC_63_6T_H = Fan_HC_63_6T_H()
    airflow_Fan_HC_63_6T_H = fan_HC_63_6T_H.get_airflow_for_pressure(pressure_drop)
    n_fans_required_HC_63_6T_H = constants.m_air * 3000 / airflow_Fan_HC_63_6T_H  # *3000 for conversion kg/s to m^3/h
    fan_lifetime_cost_HC_63_6T_H = n_fans_required_HC_63_6T_H * ( fan_HC_63_6T_H.cost 
                                        + fan_HC_63_6T_H.power /1000  # /1000 for conversion power in W to kW
                                        * LCOE_fanpower_cents /100 * 24*365 * lifetime_years )               # /100 for conversion cost in cents to $


    cost_list = [fan_lifetime_cost_CJHCH_100_8T_15, fan_lifetime_cost_HC_100_6H, fan_lifetime_cost_HFW_90_4_T_75, fan_lifetime_cost_CJHCH_80_8T_05, fan_lifetime_cost_HC_63_6T_H]
...
def calculate_total_cost_air_cooler(rho_tube, c_tm, rho_fin, c_fm, lifetime_years, LCOE_fanpower_cents, tube: Tube):
    """Compute total cost of the finned tubes [$/m]
    Args:
        rho_tube (float):   density of tube material [kg/m^3]
        c_tm (float):       cost of tube material per unit mass [$/kg]
    ...
    fan_lifetime_cost = calculate_fan_lifetime_cost(pressure_drop, lifetime_years, LCOE_fanpower_cents)

    total_cost_air_cooler =  total_cost_finned_tubes * ( 1 + constants.f_header ) * (1 + constants.f_labor ) * constants.f_HX + fan_lifetime_cost
    # this is assuming fan cost is not increasing header, labor and HX costs
